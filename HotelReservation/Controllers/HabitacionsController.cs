    ...
    public class HabitacionsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Habitaciones != null ? 
                          ...
                          Problem("Entity set 'AppDbContext.Habitaciones'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Descripcion")] Habitacion habitacion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descripcion")] Habitacion habitacion)
        {
            if (id != habitacion.Id)
            {
                return NotFound();
